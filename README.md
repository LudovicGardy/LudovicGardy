...
<p>🔬 Over the past years, my work has been largely focused on medical research, particularly in the fields of epilepsy and Alzheimer's disease. I've collaborated with multiple hospitals and research centers, collecting a variety of medical data. This includes working with medical imagery such as EEG and MRI, as well as a wide range of tabular data such as medication records, health status indicators, socio-economic information, neuropsychological evaluations, etc.</p>

<p>🧰 On the technical side, my specialization encompasses machine learning, time series or image processing, and complex database engineering. I can manage both the backend and frontend aspects of the tools I develop, ensuring an optimized and transparent user experience. </p>

<p>📊 I also have a keen interest in various data-related aspects, including multivariate modeling, statistical analyses, and data visualization.</p>

<h2>My Github Space</h2>

<p>My Github space is a hub for sharing three types of content:</p>

<ol>
  <li>📝 Analyses conducted for scientific papers that I publish with my colleagues in peer-reviewed journals.</li>
  <li>⚙️ Royalty-free or proprietary methods that I and my colleagues have developed, which are intended for use under a specified license (as mentioned in each repository).</li>
  <li>📚 Educational content or tips for students or professionals who could find these solutions useful.</li>
</ol>

<p>During my PhD from 2018 to 2021, I developed Halyzia, a software with an integrated AI that works in synergy with other signal processing algorithms. This software allows for the automatic detection of pathological brain oscillations in patients with drug-resistant epilepsy. In addition to this, Halyzia includes features for reading and interacting with EEGs and 3D images such as MRI, CT scan, PET scan, and more. With a clean design at its core, it also prioritizes transparency and usability, offering visual layers to help users understand how their data is processed.</p>
